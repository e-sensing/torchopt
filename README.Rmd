...
You can also test optimizers using optimization test functions and visualize 
them. Optimization functions are useful to evaluate characteristics of optimization algorithms, such as convergence rate, precision, robustness, and performance. `torchopt` provide some test functions to give an idea about the different situations that optimization algorithms can face when coping with optimization problems.
...
```{r gif_opt, echo=TRUE, fig.show='animate', fig.height=10, fig.width=10, animation.hook='gifski', aniopts='loop', dpi=150, interval=0.1, out.height=5, out.width=5}
